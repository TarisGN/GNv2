...
local coordonate = {
    {-1517.12, -919.31, 9.17,"Recycleur",500.77,0xC99F21C4,"s_m_y_construct_02"},
    ...
    {-1570.9993896484,-574.92303466797,107.52293395996,"Registru comertului",381.77,0xC99F21C4,"a_m_y_construct_02"}
}
    ...
    while true do
        ...
        for _,v in pairs(coordonate) do
            ...
            if(Vdist(pos.x, pos.y, pos.z, x, y, z) < 20.0)then
                ...
                DrawText3D(x,y,z+1.95, "~w~Salut", 1.0, 1)
            end
        end
    end
end)
