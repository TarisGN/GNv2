...
Bugs			|	Buglar
---------------------------------------
Wont broken glass	|	Camlar kýrýlmýyor
...
handling.meta (Zorunlu deðil önden çekiþ isterseniz || Optional for FWD)
>>> update\update.rpf\common\data

Yada handling.meta içinde;
{OR in handling.meta}

   <Item type="CHandlingData">
      <handlingName>TAXI2</handlingName>
      ...
      <fInitialDriveMaxFlatVel value="143.000000" />
