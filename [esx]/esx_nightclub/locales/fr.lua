Locales['en'] = {
    -- Cloakroom
    ['cloakroom']                = 'Vestaire',
    ['citizen_wear']             = 'Vetements civil',
    ['barman_outfit']            = 'Vetements Barman',
    ...
    ['no_outfit']                = 'Auncune tenue...',
    ['open_cloackroom']          = 'appuyez sur ~INPUT_CONTEXT~ pour vous changer',
  
    -- Vault  
    ['get_weapon']               = 'Prendre arme',
    ['put_weapon']               = 'Poser arme',
    ['get_weapon_menu']          = 'Coffre - Take weapon',
    ['put_weapon_menu']          = 'Coffre - Deposit weapon',
    ['get_object']               = 'Poser objet',
    ['put_object']               = 'Prendre objet',
    ['vault']                    = 'Coffre',
    ['open_vault']               = 'appuyez sur ~INPUT_CONTEXT~ pour acceder au coffre',
  
    -- Fridge  
    ['get_object']               = 'Prendre objet',
    ['put_object']               = 'Poser objet',
    ['fridge']                   = 'Frigo',
    ['open_fridge']              = 'appuyez sur ~INPUT_CONTEXT~ pour acceder au frigo',
    ['unicorn_fridge_stock']     = 'Frigo stock',
    ['fridge_inventory']         = 'Contenu du frigo',
  
    -- Shops  
    ['shop']                     = 'Boutique',
    ['shop_menu']                = 'appuyez sur ~INPUT_CONTEXT~ pour acceder au magasin.',
    ['bought']                   = 'Vous achetez ~b~ 1x',
    ['not_enough_money']         = 'Pas assez de monnaie.',
    ['max_item']                 = 'vous en avez deja trop sur vous.',
