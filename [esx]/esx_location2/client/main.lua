...
AddEventHandler('esx_location2:hasEnteredMarker', function(zone)
...
AddEventHandler('esx_location2:hasExitedMarker', function(zone)
    CurrentAction = nil
end)
...
Citizen.CreateThread(function()
	while true do
		...
		if (isInMarker and not HasAlreadyEnteredMarker) or (isInMarker and LastZone ~= currentZone) then
			...
			TriggerEvent('esx_location2:hasEnteredMarker', currentZone)
		end
		if not isInMarker and HasAlreadyEnteredMarker then
			HasAlreadyEnteredMarker = false
			TriggerEvent('esx_location2:hasExitedMarker', LastZone)
		end
