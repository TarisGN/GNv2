    ...
    ESX.UI.Menu.Open(
        ...
        function(data, menu)
            for i=1, #elements, 1 do
                ...
                TriggerServerEvent('esx_location4:Buy', price) -- Event permetant de faire payer le joueur
                break
            end
            menu.close()
    end,
...
AddEventHandler('esx_location4:hasEnteredMarker', function(zone)
...
AddEventHandler('esx_location4:hasExitedMarker', function(zone)
    CurrentAction = nil
end)
...
Citizen.CreateThread(function()
	while true do
		...
		if (isInMarker and not HasAlreadyEnteredMarker) or (isInMarker and LastZone ~= currentZone) then
			...
			TriggerEvent('esx_location4:hasEnteredMarker', currentZone)
		end
		if not isInMarker and HasAlreadyEnteredMarker then
			HasAlreadyEnteredMarker = false
			TriggerEvent('esx_location4:hasExitedMarker', LastZone)
		end
