    ...
    function(data, menu)
      if data.current.value == 'vehicle_list' then
        ...
        if Config.EnableSocietyOwnedVehicles then
            ...
            local elements = {
              {label = 'Livraison', value = 'rumpo6'},
              {label = 'Chef Equipe', value = 'granger'}
            }
...
function OpenTabacCraft2Menu()
  if Config.EnablePlayerManagement and PlayerData.job ~= nil then
    ...
    local elements = {
      {label = 'Blondes', value = 'malbora'},
      {label = 'Brunes', value = 'gitanes'},
      {label = 'Spliff',   value = 'splif'}
    }
          ...
          if IsControlJustReleased(0, 38) and PlayerData.job ~= nil and PlayerData.job.name == 'tabac' then
            ...
            if CurrentAction == 'delete_vehicle' then
              ...
              if Config.EnableSocietyOwnedVehicles then
                ...
                if
                  GetEntityModel(vehicle) == GetHashKey('rumpo')   or
