...
TriggerEvent('es:addCommand', 'adv', function(source, args, user)
    TriggerClientEvent('chatMessage', -1, "^0[^5PUB^0] (^5@" .. GetPlayerName(source) .. "^0)", {30, 144, 255}, table.concat(args, " "))
  end, {help = 'PUB. [IC]'})

TriggerEvent('es:addCommand', 'news', function(source, args, user)
    TriggerClientEvent('chatMessage', -1, "^0[^6NEWS^0] (^6@" .. GetPlayerName(source) .. "^0)", {30, 144, 255}, table.concat(args, " "))
  end, {help = 'PUB. [IC]'})
