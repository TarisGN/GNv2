...
-- Crafting Menu  
    ['crafting']                 = 'Cuisine',
    ['assembling_cocktail']      = 'Préparation des différents ingrédients en cours !',
    ['craft_miss']               = 'Malheureux échec de la recette...',
    ['not_enough']               = 'Pas assez de ~r~ ',
    ['craft']                    = 'Préparation terminée de ~g~',
    ['Hamburger']                = 'Hamburger',
