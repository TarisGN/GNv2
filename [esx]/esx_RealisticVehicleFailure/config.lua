...
cfg = {
	deformationMultiplier = 5.0,					-- How much should the vehicle visually deform from a collision. Range 0.0 to 10.0 Where 0.0 is no deformation and 10.0 is 10x deformation. -1 = Don't touch. Visual damage does not sync well to other players.
...
RepairWhitelist =
{
		"steam:110000104bd0d2b",
		"steam:1100001014304e8"			-- not sure if ip whitelist works?
}
