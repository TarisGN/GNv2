...
Config.Zones = {
    BikeRental = {
        ...
        Items = { -- Item, label, and price used for the menu
            {item = 'BMX', label = 'vélo BMX', price = 300},
            {item = 'CRUISER', label = 'vélo Cruiser', price = 300},
            {item = 'FIXTER', label = 'vélo Course', price = 300},
            {item = 'SCORCHER', label = 'vélo VTT', price = 300},
            {item = 'TRIBIKE', label = 'vélo Triathlon 1', price = 300},
            {item = 'TRIBIKE2', label = 'vélo Triathlon 2', price = 300},
            {item = 'TRIBIKE3', label = 'véloTriathlon 3', price = 300},
        },
        Pos = { -- Zone positions
