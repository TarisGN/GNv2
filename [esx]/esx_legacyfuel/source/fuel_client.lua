	...
	Citizen.CreateThread(function()
		while true do
			...
			if displayHud then
				...
				DrawAdvancedText(0.130 - x, 0.795 - y, 0.005, 0.0028, 0.6, kmh, 255, 255, 255, 255, 6, 1)
				DrawAdvancedText(0.174 - x, 0.795 - y, 0.005, 0.0028, 0.6, fuel, 255, 255, 255, 255, 6, 1)
				DrawAdvancedText(0.148 - x, 0.805 - y, 0.005, 0.0028, 0.4, "km/h            Litres (Réservoir)", 73, 23, 138, 255, 6, 1)
			else 
				Citizen.Wait(750)
			end
		end
