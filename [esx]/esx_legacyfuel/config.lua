...
Config.Strings = {
	ExitVehicle = "Sortez du véhicules pour faire le plein",
	EToRefuel = "Appuyez sur ~g~E ~w~ pour faire le plein",
	JerryCanEmpty = "Le bidon est VIDE",
	FullTank = "Reservoir PLEIN",
	PurchaseJerryCan = "Appuyez sur ~g~E ~w~ pour acheter un bidon pour ~g~$" .. Config.JerryCanCost,
