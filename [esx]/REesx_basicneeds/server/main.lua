...
TriggerEvent('es:addGroupCommand', 'heal', 'admin', function(source, args, user)
	...
	if args[1] then
		...
		if playerId then
			...
			if GetPlayerName(playerId) then
				...
				TriggerClientEvent('chat:addMessage', source, { args = { '^5Soin', 'Vous avez été soigné.' } })
			else
				TriggerClientEvent('chat:addMessage', source, { args = { '^1SYSTEM', 'Joueur pas en ligne.' } })
			end
		else
			TriggerClientEvent('chat:addMessage', source, { args = { '^1SYSTEM', 'ID invalide.' } })
		end
	else
	...
	TriggerClientEvent('chat:addMessage', source, { args = { '^1SYSTEM', 'Pas la permission.' } })
