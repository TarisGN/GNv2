...
files {
    ...
    'html/img/items/batterie.png',
    'html/img/items/batterie_rech.png',
    'html/img/items/tabacbrun.png',
    'html/img/items/pochoncoke.png',
    'html/img/items/dosecoke.png',
    'html/img/items/tabacblondsec.png',
    'html/img/items/tabacbrunsec.png',
    'html/img/items/malbora.png',
    'html/img/items/gitanes.png',
    'html/img/items/huile.png',
    'html/img/items/huiles.png',
    'html/img/items/canettes.png',
    'html/img/items/ferraille.png',
    'html/img/items/ticket.png',
    ...
    'html/img/items/viande_meat.png',
    ...
    'html/img/items/caisse.png',
    'html/img/items/caissemed.png',
    'html/img/items/medicament.png',
    'html/img/items/contract.png',
    'html/img/items/biere.png',
    'html/img/items/sake.png',
